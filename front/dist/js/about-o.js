...
/******/ 	var hotCurrentHash = "70f425bdfea5f26c7533"; // eslint-disable-line no-unused-vars
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;console.log('load jquery.min.js');
...
_xTagCore2.default.register('x-head', {
...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // 首页组件


var About = function About() {
	_classCallCheck(this, About);

	(0, _jqueryMin2.default)('li:eq(2)').css('background', 'gainsboro');
};
